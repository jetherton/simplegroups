...
<div id="error"> 
	...
	<br/><br/>
	If you have another use account you can <a href="<?php echo url::site()."admin/";?>log_out"><?php echo Kohana::lang('ui_admin.logout');?></a> and then log back in using that user account.
	<br/><br/> Thank you.
</div> 
</body> 
</html>