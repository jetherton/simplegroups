...
?>
			<div class="bg">
				<h2>
					<?php groups::reports_subtabs("comments"); ?>
				</h2>
				<!-- tabs -->
				<div class="tabs">
					<!-- tabset -->
									...
									<tr>
										...
										<td class="col-2">
											<div class="post">
												...
												if ($incident_title != "")
												{
													?><div class="comment_incident"><?php echo Kohana::lang('ui_main.in_response_to');?>: <strong><a href="<?php echo url::base() . 'admin/simplegroups/reports/edit/' . $incident_id; ?>"><?php echo $incident_title; ?></a></strong></div><?php
												}
												?>
