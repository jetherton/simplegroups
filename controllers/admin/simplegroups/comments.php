...
class Comments_Controller extends Admin_simplegroup_Controller
{
    ...
    */
    ...
    {
        $this->template->content = new View('simplegroups/comments');
        ...
        $pagination = new Pagination(array(
            ...
            'total_items'    => ORM::factory('comment')
						->join("simplegroups_groups_incident", "comment.incident_id", "simplegroups_groups_incident.incident_id")
						->where($filter . " AND (simplegroups_groups_incident.simplegroups_groups_id = ".$this->group->id.") ")
						->count_all()
        ));
        ...
        // Javascript Header
        $this->template->js = new View('simplegroups/comments_js');        
    }
